return{
    descriptions = {
        Joker = {
            ...
            j_arsonist = {
                name = "Arsonist",
                text = {
                    "Upgrades the first {C:attention}discarded{} poker hand each round,",
                    "increases {C:attention}#1#{} times if the hand contains {C:attention}#2#{}",
                    "also reduces the {C:attention}rank{} of cards",
                    "cards of rank {C:attention}2{} are destroyed",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_The_Eternal_Duet = {
                name = "The Eternal Duet",
                text = {
                    "Gains {X:mult,C:white}X#1#{} mult.",
                    "if the played hand contains a {C:attention}Pair{}",
                    "{C:inactive}(currently {X:mult,C:white}X#2#{C:inactive} mult.)",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            ...
            j_triple_portion = {
                ...
                text = {
                    ...
                    "grants chips equal to the blind's requirement to win",
                    "{C:inactive}Current: {C:chips}+#2#{} chips",
                    "{C:inactive}Portions left: {C:chips}#1#{}",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_Three_day_siege = {
                name = "Three-Day Siege",
                text = {
                    "This Joker gains {C:chips}+#1#{} chips",
                    "for each discarded {V:1}#3#{} card (suit changes every round)",
                    "triples bonus if the card is a {C:attention}3{}",
                    "triples again if a {C:attention}Three of a Kind{} is discarded",
                    "{C:inactive}(currently {C:chips}+#2#{C:inactive} chips)",
                    "Recipe: {C:inactive}(#4# + #5#)"
                },
            },
            j_mighty_quartet = {
                name = "Mighty Quartet",
                text = {
                    "{C:attention}Two Pair{} counts as {C:attention}Four of a Kind{},",
                    "{C:attention}Four of a Kind{} includes {C:attention}Two Pair{}",
                    "Gains {X:mult,C:white}X#1#{} mult.",
                    "if the played hand is a {C:attention}Four of a Kind{}",
                    "{C:inactive}(currently {X:mult,C:white}X#2#{C:inactive} mult.)",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_twisted_pant_legs = {
                name = "Twisted Pant Legs",
                text = {
                    "This Joker gains {C:mult}+#2#{} mult.",
                    "if the hand contains {C:attention}Two Pair{}",
                    "playing {C:attention}Two Pair{} {C:attention}twists{} the pairs together",
                    "playing one of the {C:attention}twisted{} pairs from hand/deck/discard",
                    "brings out and plays the other {C:attention}twisted{} pair",
                    "Only 2 pairs can be {C:attention}twisted{} at once",
                    "Using twisted pair grants this Joker {C:mult}+#4#{} mult.",
                    "Current twisted cards: {C:inactive}(#3#)",
                    "{C:inactive}(Current mult: {C:red}+#1#{C:inactive})",
                    "Recipe: {C:inactive}(#5# + #6#)"
                },
            },
            j_order_of_madness = {
                name = "Order of Madness",
                text = {
                    "Gains {X:mult,C:white}X#1#{} mult.",
                    "if the played hand contains a {C:attention}Straight{}",
                    "{C:inactive}(currently {X:mult,C:white}X#2#{C:inactive} mult.)",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_amateur_marathon = {
                name = "Amateur Marathon",
                text = {
                    "If the hand is a {C:attention}Straight{},",
                    "this Joker gains {C:chips}+#3#{} chips",
                    "for each Joker to its {C:attention}left{}",
                    "and {C:mult}+#4#{} mult. for each to its {C:attention}right{}",
                    "{C:attention}Straight{} will be played {C:attention}automatically{}",
                    "{C:inactive}(currently {C:chips}+#1#{} chips, {C:mult}+#2#{} mult.)",
                    "Recipe: {C:inactive}(#5# + #6#)"
                },
            },
            j_cheerful_tribe = {
                ...
                text = {
                    "Gains {X:mult,C:white}X#1#{} mult.",
                    "if the hand is a {C:attention}Flush{}",
                    "{C:inactive}(currently {X:mult,C:white}X#2#{C:inactive} mult.)",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_smile_in_stone = {
                name = "Smile in Stone",
                text = {
                    "Each played card with suit {V:1}#2#{}",
                    "grants {X:mult,C:white}X#1#{} mult. during scoring,",
                    "{s:0.8}suit changes at end of round",
                    "Cards of other suits are {C:attention}weakened{}",
                    "Recipe: {C:inactive}(#3# + #4#)"
                },
            },
            j_landslide = {
	...
	misc = {
        ...
        dictionary={
            ...
            ml_j_arsonist_short_description = {
                "Increases level of the first discarded poker hand",
                "If the hand has a pair — increases twice and lowers ranks",
            },
            ml_j_The_Eternal_Duet_short_description = {
                "Grants mult. for playing a pair",
                "Mult. increases with each pair played",
            },
            ml_j_The_Great_Trio_short_description = {
                "Grants mult. for playing a three of a kind",
                "Mult. increases with each set played",
            },
            ml_j_triple_portion_short_description = {
                "three of a kind gives chips equal to blind's value",
                "Has limited number of uses",
            },
            ml_j_Three_day_siege_short_description = {
                "Gives chips for discarding cards of a specific suit",
                "Bonus triples for 3s and discarded sets",
            },
            ml_j_mighty_quartet_short_description = {
                "Two pairs count as four of a kind and vice versa",
                "Grants mult. for playing four of a kind",
            },
            ml_j_twisted_pant_legs_short_description = {
                "Grants mult. for playing two pairs",
                "Twists card pairs to help find two pairs",
            },
            ml_j_order_of_madness_short_description = {
                "Grants mult. for playing a straight",
                "Mult. increases with each straight played",
            },
            ml_j_amateur_marathon_short_description = {
                "Automatically plays a straight",
                "Grants chips for jokers on the left and mult. on the right",
            },
            ml_j_cheerful_tribe_short_description = {
                "Grants mult. for playing a flush",
                "Mult. increases with each flush played",
            },
            ml_j_smile_in_stone_short_description = {
                "Grants mult. for cards of a certain suit",
                "Suit changes; other suits are weakened",
            },
